...
from util.load_data import load_data_list, load_data_C
...
for feature_name in feature_enum.all_feature_list:
    for cv_index in range(10):
        ...
        model_save_path = f'{p}/weights/202240_feature_importance/NN_best≥C_time_steps=1'
        if not os.path.exists(model_save_path):
            os.makedirs(model_save_path)
        model_save_path = f'{model_save_path}/NN_C_best_{cv_index}.h5'
